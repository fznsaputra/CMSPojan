      ...
      <?php foreach ($galeri as $aa) { ?>
        <div class="col-md-12 mb-3 mt-3">
          <div class="card h-100">
            <img class="card-img-top" src="<?= base_url("assets/upload/galeri/").$aa['foto']; ?>" target="_blank">
            <div class="card-body">
              <h5 class="card-title"><?= $aa['judul'] ?></h5>
              <a class="btn btn-square btn-danger m-2 " onClick="return confirm('Are You Sure About This?')" href="<?= base_url('admin/galeri/hapus/' . $aa['foto']) ?>">
